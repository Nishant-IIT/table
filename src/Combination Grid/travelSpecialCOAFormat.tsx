...
import { travelSpecialCOAFormat } from '../Data/Data';
import React, { useEffect, useRef, useState } from 'react';

// register Handsontable's modules  
registerAllModules();

function TravelSpecialCOA() {
    ...
    return (
        <>
            ...
            <HotTable
                ref={hotRef}
                data={travelSpecialCOAFormat}
                rowHeaders={true}
                colHeaders={['Approval Sr No', 'Producer Code', 'Producer Name', 'Producer PAN', 'Channel', 'Sub-Channel', 'Branch Location', 'Location Category', 'Effectivefrom(Prod Mn date)', 'Effective till (Prod Mn date)', 'LOB', '(Product)', 'Business Type', 'Sum Insured', 'Segment (X,W,D)', 'Times Renewed Ct Cat', 'LOB Loc. Cat (P,SP,NP)', 'Product_cd', 'Master Policy No', 'Master Policy Type', 'Insured Age', 'Plan Name', 'Addon - VAS', 'Trip Tenure Category', 'Approval Grid', 'Approval Grid for Per Policy ', 'Created By', 'Created By Code', 'Approved By', 'Approved By Code', 'Rejected By', 'Rejected By Code', 'Created On', 'Rejected On', 'Approved On', 'Modified On', 'Status', 'Mapped User', 'Mapped User Code', 'Reporting Manager', 'Reporting Manager Code']}
                height="auto"
                fixedRowsTop={1}
...
export default TravelSpecialCOA;