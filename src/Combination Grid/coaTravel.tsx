...
import { coaTravel } from '../Data/Data';
    ...
    return (
        <>
            ...
            <HotTable
                ...
                data={coaTravel}
                rowHeaders={true}
                colHeaders={['Special Approval Grid Master (Travel)', 'column_1', 'column_2', 'column_3', 'column_4', 'month (Prodcom Month)",', 'column_5', 'month (Prodcom Month)",', 'Travel', 'column_7', '(Inc IRDA + R&R + PO)']}
                height="auto"
                fixedRowsTop={1}
                ...
                columns={[
                    {
                        "data": "Special Approval Grid Master (Travel)",
                        "readOnly": true
                    },
                    {
                        "data": "column_1",
