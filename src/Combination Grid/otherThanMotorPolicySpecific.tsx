...
import { otherThanMotorPolicySpecific } from '../Data/Data';
import React, { useEffect, useRef, useState } from 'react';

// register Handsontable's modules  
registerAllModules();

function OtherThanMotorPolicySpecific() {
    ...
    return (
        <>
            ...
            <HotTable
                ref={hotRef}
                data={otherThanMotorPolicySpecific}
                rowHeaders={true}
                colHeaders={['Policy Number', 'Producer Code', 'Producer Name', 'Channel', 'Prodcom Month', 'LOB1', 'Approval Grid (Including IRDA+R&R+PO)']}
                height="auto"
                fixedRowsTop={1}
                ...
                columns={[
                    ...
                    {
                        "data": "Approval Grid (Including IRDA+R&R+PO)",
                        "readOnly": true
                    }
                ]
                }
...
export default OtherThanMotorPolicySpecific;