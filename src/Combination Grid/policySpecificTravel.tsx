...
import { policySpecificTravel } from '../Data/Data';
import React, { useEffect, useRef, useState } from 'react';

// register Handsontable's modules  
registerAllModules();

function PolicySpecificTravel() {
    ...
    return (
        <>
            ...
            <HotTable
                ref={hotRef}
                data={policySpecificTravel}
                rowHeaders={true}
                colHeaders={['Policy Wise', 'Client Name', 'Premium', 'Producer Code', 'Producer Name', 'Producer PAN', 'Channel', 'Sub-Channel', 'Branch Location', 'Location Category', 'Prodcom Month', 'LOB1', 'Approval Grid', 'Approval Grid for Per Policy ', 'Created By', 'Created By Code', 'Approved By', 'Approved By Code', 'Rejected By', 'Rejected By Code', 'Created On', 'Rejected On', 'Approved On', 'Modified On', 'Status', 'Mapped User', 'Mapped User Code', 'Reporting Manager', 'Reporting Manager Code']}
                height="auto"
                fixedRowsTop={1}
...
export default PolicySpecificTravel;