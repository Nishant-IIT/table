...
import { pvtCarSpecialCOAFormat } from '../Data/Data';
import React, { useEffect, useRef, useState } from 'react';

// register Handsontable's modules  
registerAllModules();

function PvtCarSpecialCOA() {
    ...
    return (
        <>
            ...
            <HotTable
                ref={hotRef}
                data={pvtCarSpecialCOAFormat}
                rowHeaders={true}
                colHeaders={['Approval Sr No', 'Producer Code', 'Producer Name', 'Producer PAN', 'Channel', 'Sub-Channel', 'Branch Location', 'Location Category', 'Effectivefrom(Prod Mn date)', 'Effective till (Prod Mn date)', 'LOB', '(Product)', 'Business Type', 'Make', 'Model', 'Cubic Capacity', 'Segment', 'VehicleClass', 'Fuel Type', 'Section Text ', 'RTO', 'With CPA', 'NCB', 'Vehicle Age Cat', 'Ensure Grid Applicability', 'Lower Discount', 'Upper Discount', 'Approval Grid for OD Portion', 'Approval Grid for TP Portion', 'Approval Grid for Per Policy ', 'Created By', 'Created By Code', 'Approved By', 'Approved By Code', 'Rejected By', 'Rejected By Code', 'Created On', 'Rejected On', 'Approved On', 'Modified On', 'Status', 'Mapped User', 'Mapped User Code', 'Reporting Manager', 'Reporting Manager Code']}
                height="auto"
                fixedRowsTop={1}
...
export default PvtCarSpecialCOA;